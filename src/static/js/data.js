const YAM_TOKEN_ADDR = '0x0aacfbec6a24756c20d41914f2caba817c0d8521'
...
const SAFE_TOKEN_ADDR = '0x1Aa61c196E76805fcBe394eA00e4fFCEd24FC469'

const DAI_SAFE_BPT_TOKEN_ADDR = '0x3031745e732dce8fecccc94aca13d5fa18f1012d'
const DAI_SAFE_TOKEN_STAKING_ADDR = '0x668d052775CA6F11A07FafE7859dB777e253eaf9'

const SAFE_REWARDS_POOL_ABI = [
  {
    anonymous: false,
    inputs: [
...
const YAM_TOKEN_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'address', name: 'oldIncentivizer', type: 'address'},
      {indexed: false, internalType: 'address', name: 'newIncentivizer', type: 'address'},
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'address', name: 'oldPendingGov', type: 'address'},
      {indexed: false, internalType: 'address', name: 'newPendingGov', type: 'address'},
    ],
    name: 'NewPendingGov',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'address', name: 'oldRebaser', type: 'address'},
      {indexed: false, internalType: 'address', name: 'newRebaser', type: 'address'},
    ],
    name: 'NewRebaser',
    type: 'event',
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'uint256', name: 'prevYamsScalingFactor', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'newYamsScalingFactor', type: 'uint256'},
    ],
    name: 'Rebase',
    type: 'event',
  },
  ...
  {
    constant: false,
    inputs: [{internalType: 'address', name: 'incentivizer_', type: 'address'}],
  ...
  {
    constant: false,
    inputs: [{internalType: 'address', name: 'newPendingGov', type: 'address'}],
    name: '_setPendingGov',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
...
const DAI_YFVAULT_ADDR = '0x96724528fa59c5df684d720f0f79ccf2190b8c01'
const DAI_YFPOOL_ADDR = '0xe6db24ba51ceae1aed2e6e7a6fdba5e4fe2a75c8'

const USDC_YFVAULT_ADDR = '0xcf22bea5113e4fe38babefd6973b5383667cb5b3'
const USDC_YFPOOL_ADDR = '0x785690877eca2bcfcd268d8c5e22c59a6cf14c55'

const USDT_YFVAULT_ADDR = '0xa315f861788a59dd470c50093a1b08ef820ab8b6'
const USDT_YFPOOL_ADDR = '0x1f1ef2d79641640b5fe8a294a7bba95f571cdc4b'
...
const YAXIS_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract YaxisToken', name: '_yax', type: 'address'},
      {internalType: 'address', name: '_tresuryaddr', type: 'address'},
      {internalType: 'uint256', name: '_yaxPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accYaxPerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [
      {internalType: 'uint8', name: '_index', type: 'uint8'},
      {internalType: 'uint256', name: '_epochRewardMultipler', type: 'uint256'},
    ],
  ...
  {
    inputs: [{internalType: 'uint256', name: '_yaxPerBlock', type: 'uint256'}],
    name: 'setYaxPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'address', name: '_tresuryaddr', type: 'address'}],
    name: 'tresury',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accumulatedStakingPower', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [],
    name: 'yax',
    outputs: [{internalType: 'contract YaxisToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
const PICKLE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract PickleToken', name: '_pickle', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_picklePerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'pickle',
    outputs: [{internalType: 'contract PickleToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accPicklePerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_picklePerBlock', type: 'uint256'}],
...
const HOLY_KNIGHT_ABI = [
  {
    inputs: [
      {internalType: 'contract HolyToken', name: '_token', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_treasuryaddr', type: 'address'},
      {internalType: 'uint256', name: '_totalsupply', type: 'uint256'},
      {internalType: 'uint256', name: '_reservedPercent', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_targetEndBlock', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  ...
  },
  {
    inputs: [
      {internalType: 'uint256', name: '_allocPoint', type: 'uint256'},
      {internalType: 'contract IERC20', name: '_lpToken', type: 'address'},
      {internalType: 'bool', name: '_stakeable', type: 'bool'},
      {internalType: 'address', name: '_stakeableContract', type: 'address'},
      {internalType: 'contract IERC20', name: '_stakedHoldableToken', type: 'address'},
      {internalType: 'bool', name: '_withUpdate', type: 'bool'},
    ],
    name: 'add',
    outputs: [],
  ...
  },
  {
    inputs: [],
    name: 'holytoken',
    outputs: [{internalType: 'contract HolyToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {inputs: [], name: 'massUpdatePools', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'contract IERC20', name: 'lpToken', type: 'address'},
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardCalcBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accHolyPerShare', type: 'uint256'},
      {internalType: 'bool', name: 'stakeable', type: 'bool'},
      {internalType: 'address', name: 'stakeableContract', type: 'address'},
      {internalType: 'contract IERC20', name: 'stakedHoldableToken', type: 'address'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_reservedPercent', type: 'uint256'}],
    name: 'setReserve',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'uint256', name: 'amount', type: 'uint256'},
      {internalType: 'uint256', name: 'rewardDebt', type: 'uint256'},
      {internalType: 'uint256', name: 'stakedLPAmount', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
const CAPTAIN_COOK_ABI = [
  {
    inputs: [
      {internalType: 'contract SwapShipToken', name: '_swapship', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'migrator',
    outputs: [{internalType: 'contract IMigratorCaptain', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'contract IMigratorCaptain', name: '_migrator', type: 'address'}],
    name: 'setMigrator',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [],
    name: 'swapship',
    outputs: [{internalType: 'contract SwapShipToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
const OPERATOR_ABI = [
  {
    inputs: [
      {internalType: 'contract StabilizeToken', name: '_stabilize', type: 'address'},
      {internalType: 'contract StabilizePriceOracle', name: '_oracle', type: 'address'},
  ...
  {inputs: [], name: 'bootstrapLiquidty', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'currentWeek',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
  ...
  {inputs: [], name: 'finishChangeBurnRateLong', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangeEarlyBurnRate', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangeEmissionRateLong', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangePriceOracle', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangeRewardPercentLP', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangeTargetPrice', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishOwnerChange', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_percent', type: 'uint256'}],
    name: 'startChangeEmissionRateLong',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
const MASTER_FARMER_ABI = [
  {
    inputs: [
      {internalType: 'contract LuaToken', name: '_lua', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'lua',
    outputs: [{internalType: 'contract LuaToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {inputs: [], name: 'massUpdatePools', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  ...
  },
  {
    inputs: [],
    name: 'migrator',
    outputs: [{internalType: 'contract IMigratorToLuaSwap', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accLuaPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'contract IMigratorToLuaSwap', name: '_migrator', type: 'address'}],
    name: 'setMigrator',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
const STAKING_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_metric', type: 'address'},
...
const PCT_POOL_ABI = [
  ...
  {
    inputs: [
      {name: 'pctAddress', type: 'address'},
      {name: 'stakeTokenAddress', type: 'address'},
    ],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'constructor',
...
const MASTER_VAMPIRE_ABI = [
  {
    inputs: [
      {internalType: 'contract DraculaToken', name: '_dracula', type: 'address'},
      {internalType: 'address', name: '_drainAddress', type: 'address'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  ...
  {
    inputs: [
      {internalType: 'contract Victim', name: '_victim', type: 'address'},
      {internalType: 'uint256', name: '_victimPoolId', type: 'uint256'},
      {internalType: 'uint256', name: '_rewardPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_rewardDrainModifier', type: 'uint256'},
      {internalType: 'uint256', name: '_wethDrainModifier', type: 'uint256'},
    ],
    name: 'add',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [],
    name: 'dracula',
    outputs: [{internalType: 'contract DraculaToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'poolInfo',
    outputs: [
      {internalType: 'contract Victim', name: 'victim', type: 'address'},
      {internalType: 'uint256', name: 'victimPoolId', type: 'uint256'},
      {internalType: 'uint256', name: 'rewardPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accDrcPerShare', type: 'uint256'},
      {internalType: 'uint256', name: 'rewardDrainModifier', type: 'uint256'},
      {internalType: 'uint256', name: 'wethDrainModifier', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'address', name: '_drainAddress', type: 'address'}],
  ...
  {
    inputs: [{internalType: 'uint256', name: '_poolRewardLimiter', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'address', name: '_poolRewardUpdater', type: 'address'}],
...
const KITTEN_201_ABI = [
  ...
  },
  {
    constant: false,
    inputs: [
      {internalType: 'uint256', name: '_initFactor', type: 'uint256'},
      {internalType: 'uint256', name: '_reductionFactor', type: 'uint256'},
    ],
    name: 'startPool',
    outputs: [],
    payable: false,
...
const HYPE_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_rewardToken', type: 'address'},
      {internalType: 'address', name: '_lptoken', type: 'address'},
      {internalType: 'contract IRewardReceiver', name: '_rewardReceiver', type: 'address'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  ...
  },
  {
    inputs: [],
    name: 'rewardReceiver',
    outputs: [{internalType: 'contract IRewardReceiver', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
const YAM_INCENTIVIZER_ABI = [
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'uint32', name: 'fromBlock', type: 'uint32'},
      {internalType: 'uint256', name: 'lpStake', type: 'uint256'},
    ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    constant: false,
    inputs: [],
    name: 'emergencyMasterChefWithdraw',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{internalType: 'bool', name: 'breaker_', type: 'bool'}],
    name: 'setBreaker',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{internalType: 'address', name: 'newReserves', type: 'address'}],
    name: 'setReserves',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{internalType: 'uint256', name: 'xsushi_amt', type: 'uint256'}],
    name: 'sushiToReserves',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    inputs: [],
    name: 'sushibar',
    outputs: [{internalType: 'contract SushiBar', name: '', type: 'address'}],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
...
const ICHI_FARM_ABI = [
  {
    inputs: [
      {internalType: 'contract IERC20', name: '_ichi', type: 'address'},
      {internalType: 'uint256', name: '_ichiPerBlock', type: 'uint256'},
      {internalType: 'address', name: '_oneFactorContract', type: 'address'},
      {internalType: 'address', name: '_ichiEthOracle', type: 'address'},
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'uint256', name: 'winners', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'ichiPaid', type: 'uint256'},
    ],
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'maxLoops', type: 'uint256'}],
    name: 'NewMaxBlock',
    type: 'event',
  },
  {
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_totalRanks', type: 'uint256'},
      {internalType: 'uint256', name: '_currentBlockNumber', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    name: 'getValueKey',
    outputs: [{internalType: 'address', name: '_key', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'address', name: 'contract_', type: 'address'}],
  ...
  },
  {
    ...
    outputs: [{internalType: 'uint256', name: '_percentile', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'valuePermil',
    outputs: [{internalType: 'uint256', name: '_permil', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'valueRank',
    outputs: [{internalType: 'uint256', name: '_rank', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'valuesAbove',
    outputs: [{internalType: 'uint256', name: '_above', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'valuesBelow',
    outputs: [{internalType: 'uint256', name: '_below', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
const TRUE_FARM_ABI = [
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'who', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'amountUnstaked', type: 'uint256'},
    ],
    name: 'Unstake',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'contract ITrueDistributor', name: '_trueDistributor', type: 'address'},
  ...
  },
  {
    ...
    outputs: [{internalType: 'contract ITrueDistributor', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
const TRUEFI_DISTRIBUTOR_ABI = [
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'address', name: 'newFarm', type: 'address'}],
    name: 'FarmChanged',
    type: 'event',
  },
  {
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_distributionStart', type: 'uint256'},
      {internalType: 'uint256', name: '_duration', type: 'uint256'},
      {internalType: 'uint256', name: '_amount', type: 'uint256'},
      {internalType: 'contract IERC20', name: '_trustToken', type: 'address'},
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
...
const MARK_FAUCET_ABI = [
  {
    inputs: [
      {internalType: 'contract IERC20', name: '_MARK', type: 'address'},
      {internalType: 'uint256', name: '_markPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_endBlock', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accMarkPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
const BASIS_SUSD_ABI = [
  {
    inputs: [
      {internalType: 'address', name: 'basisCash_', type: 'address'},
      {internalType: 'address', name: 'susd_', type: 'address'},
...
const MIC_DAI_ABI = [
  {
    inputs: [
      {internalType: 'address', name: 'mithCash_', type: 'address'},
...
const MIC_BAC_ABI = [
  {
    inputs: [
      {internalType: 'address', name: 'mithCash_', type: 'address'},
      {internalType: 'address', name: 'bac_', type: 'address'},
      {internalType: 'uint256', name: 'starttime_', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
...
const MIC_MITH_ABI = [
  {
    inputs: [
      {internalType: 'address', name: 'mithCash_', type: 'address'},
      {internalType: 'address', name: 'mith_', type: 'address'},
      {internalType: 'uint256', name: 'starttime_', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
...
const MIC_AAVE_ABI = [
  {
    inputs: [
      {internalType: 'address', name: 'mithCash_', type: 'address'},
      {internalType: 'address', name: 'aave_', type: 'address'},
      {internalType: 'uint256', name: 'starttime_', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
...
const CVP_CHEF_ABI = [
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'lpVotes', type: 'uint256'}],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: true, internalType: 'uint256', name: 'pid', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'lpVotes', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'pendedVotes', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'lpVotesShare', type: 'uint256'},
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: true, internalType: 'address', name: 'oldLpToken', type: 'address'},
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'cvpPerBlock', type: 'uint256'}],
    name: 'SetCvpPerBlock',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      {indexed: true, internalType: 'address', name: 'metaPool', type: 'address'},
      {indexed: true, internalType: 'address', name: 'cvpPool', type: 'address'},
    ],
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'cvpVestingPeriodInBlocks', type: 'uint256'}],
  ...
  {
    anonymous: false,
    inputs: [{indexed: true, internalType: 'address', name: 'migrator', type: 'address'}],
    name: 'SetMigrator',
    type: 'event',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'bool', name: '_votesEnabled', type: 'bool'},
    ],
    name: 'add',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'book',
    outputs: [
      {internalType: 'uint32', name: 'numCheckpoints', type: 'uint32'},
      {internalType: 'uint32', name: 'lastCheckpointBlock', type: 'uint32'},
      {internalType: 'address', name: 'delegatee', type: 'address'},
    ],
    stateMutability: 'view',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'address', name: 'delegatee_', type: 'address'}],
    name: 'delegate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'uint32', name: 'userCheckpointId', type: 'uint32'},
      {internalType: 'uint32', name: 'sharedCheckpointId', type: 'uint32'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      {internalType: 'address', name: 'account', type: 'address'},
      {internalType: 'uint32', name: 'checkpointId', type: 'uint32'},
    ],
    name: 'getCheckpoint',
    outputs: [
      {internalType: 'uint32', name: 'fromBlock', type: 'uint32'},
      {internalType: 'uint96', name: 'cvpAmount', type: 'uint96'},
  ...
  {
    inputs: [
      {internalType: 'contract IERC20', name: '_cvp', type: 'address'},
      {internalType: 'address', name: '_reservoir', type: 'address'},
      {internalType: 'uint256', name: '_cvpPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_cvpVestingPeriodInBlocks', type: 'uint256'},
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [],
    name: 'migrator',
    outputs: [{internalType: 'contract ILpTokenMigrator', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'contract IERC20', name: 'lpToken', type: 'address'},
      {internalType: 'bool', name: 'votesEnabled', type: 'bool'},
      {internalType: 'uint8', name: 'poolType', type: 'uint8'},
      {internalType: 'uint32', name: 'allocPoint', type: 'uint32'},
      {internalType: 'uint32', name: 'lastUpdateBlock', type: 'uint32'},
      {internalType: 'uint256', name: 'accCvpPerLpt', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_cvpPerBlock', type: 'uint256'}],
    name: 'setCvpPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      {internalType: 'address', name: '_metaPool', type: 'address'},
      {internalType: 'address', name: '_cvpPool', type: 'address'},
    ],
    name: 'setCvpPoolByMetaPool',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{internalType: 'uint256', name: '_cvpVestingPeriodInBlocks', type: 'uint256'}],
    name: 'setCvpVestingPeriodInBlocks',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'contract ILpTokenMigrator', name: '_migrator', type: 'address'}],
    name: 'setMigrator',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'uint32', name: 'lastUpdateBlock', type: 'uint32'},
      {internalType: 'uint32', name: 'vestingBlock', type: 'uint32'},
      {internalType: 'uint96', name: 'pendedCvp', type: 'uint96'},
...
const CURVE_SWAP_ABI = [
  ...
  {name: 'A', outputs: [{type: 'uint256', name: ''}], inputs: [], stateMutability: 'view', type: 'function', gas: 5199},
  {
    name: 'A_precise',
  ...
  {name: 'stop_ramp_A', outputs: [], inputs: [], stateMutability: 'nonpayable', type: 'function', gas: 148655},
  {
    name: 'commit_new_fee',
    outputs: [],
    inputs: [
  ...
  {name: 'apply_new_fee', outputs: [], inputs: [], stateMutability: 'nonpayable', type: 'function', gas: 97272},
  {name: 'revert_new_parameters', outputs: [], inputs: [], stateMutability: 'nonpayable', type: 'function', gas: 21925},
  {
  ...
  {name: 'withdraw_admin_fees', outputs: [], inputs: [], stateMutability: 'nonpayable', type: 'function', gas: 9232},
  {name: 'donate_admin_fees', outputs: [], inputs: [], stateMutability: 'nonpayable', type: 'function', gas: 74995},
  {name: 'kill_me', outputs: [], inputs: [], stateMutability: 'nonpayable', type: 'function', gas: 38028},
  {name: 'unkill_me', outputs: [], inputs: [], stateMutability: 'nonpayable', type: 'function', gas: 22165},
  {
    name: 'coins',
...
const STABLES_POOL_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_bsd', type: 'address'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'contract IERC20', name: 'lpToken', type: 'address'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accBsdPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
const DEBASE_STAKING_POOL_ABI = [
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'startedAt', type: 'uint256'}],
    name: 'ManualPoolStarted',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  {
    inputs: [
      {internalType: 'string', name: 'poolName_', type: 'string'},
      {internalType: 'address', name: 'rewardToken_', type: 'address'},
      {internalType: 'address', name: 'pairToken_', type: 'address'},
      {internalType: 'bool', name: 'isUniPair', type: 'bool'},
      {internalType: 'address', name: 'orchestrator_', type: 'address'},
      {internalType: 'uint256', name: 'duration_', type: 'uint256'},
      {internalType: 'bool', name: 'manualStartPool_', type: 'bool'},
      {internalType: 'uint256', name: 'oracleStartTimeOffset', type: 'uint256'},
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {inputs: [], name: 'startPool', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'startTime',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
...
const FRAX_STAKING_POOL_ABI = [
  {
    inputs: [
      ...
      {internalType: 'uint256', name: '_pool_weight', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_new_rate', type: 'uint256'}],
    name: 'setRewardRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
const _1INCH_FARMING_ABI = [
  ...
  {inputs: [], name: 'discardDecayPeriodVote', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'discardFeeVote', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'discardSlippageFeeVote', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [{internalType: 'address', name: 'account', type: 'address'}],
    name: 'earned',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
...
const ONECASH_ABI = [
  {
    inputs: [
      {internalType: 'address', name: 'oneShare_', type: 'address'},
      {internalType: 'address', name: 'lptoken_', type: 'address'},
      {internalType: 'uint256', name: 'starttime_', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
...
const Contracts = {
  ...
  BSD: {
    //Bullset
    DAO: {
      address: '0x0E182c65D2bF128DbB28fB6F2B9EdD65B0142b4C',
      abi: [
        {
          anonymous: false,
          inputs: [
    ...
    BSD: {
      address: '0x0afb6a6ba319202464c75ed09f2010d883257ca9',
    },
    Oracle: {
      address: '',
    },
    Uniswap_BSD_USDC: {
      address: '0x043F62e75D3e74f47a91408a8376bf00391Aa227',
    },
    LPIncentivizationPool: {
      address: '0xe8aa528d11d89c137f79a6d1ca7dfddc41dcf9b0',
      abi: [
        {inputs: [], payable: false, stateMutability: 'nonpayable', type: 'constructor'},
        {
          anonymous: false,
  ...
  SPAD: {
    //Spacedollar
    DAO: {
      address: '0xaDbEf24Df642dE86B95e2259f367463f6aEC9047',
      abi: [
        {
          anonymous: false,
          inputs: [
    ...
    Dollar: {
      address: '0x4b5216498b646af3121840e7984d466878f2dbcf',
    },
    Oracle: {
      address: '',
    },
    UniswapLP: {
      address: '0x31AEe89FE6c1f3E280f6edd1bF00E6f6f2ce6563',
    },
    LPIncentivizationPool: {
      address: '0x7bbCA777365902059979C320bB724eED377Fd3D7',
      abi: [
        {
          inputs: [
  ...
  ZSD: {
    //Zeroset
    DAO: {
      address: '0x80a861e3e08bbc2afd33d2f9885423a7addeb8e1',
      abi: [
        {
          anonymous: false,
          inputs: [
    ...
    Dollar: {
      address: '0x3246ac4f28148c75e18152ba4d80c93606555ad0',
    },
    Oracle: {
      address: '',
    },
    UniswapLP: {
      address: '0x2e9a5f63e4d20cb865c87072a888a5ea72584b73',
    },
    LPIncentivizationPool: {
      address: '0x9bb44cf38bf5d16cabbda52edb8a5513dcec6138',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'dollar', type: 'address'},
  ...
  PSD: {
    DAO: {
      address: '0x5de89cb4d6Dc83A2A3279D8d9De936d870e0e7e8',
      abi: [
        {
          anonymous: false,
          inputs: [
    ...
    PSD: {
      address: '0xdF6efd9fDe2D30a0E750519bedD2698F264C669E',
    },
    Oracle: {
      address: '',
    },
    Uniswap_USDC_PSD: {
      address: '0x60Fd9721617c199098C7F6a39b33657F827F7530',
    },
    LPIncentivizationPool: {
      address: '0x9B5C5f5669e4660C91adE5aBDDE799053E69A73b',
      abi: [
        {inputs: [], payable: false, stateMutability: 'nonpayable', type: 'constructor'},
        {
          anonymous: false,
  ...
  BASIS_COIN: {
    Oracle: {
      address: '0x6034CD085B40dDE7f658EBc65b909aF7765a296a',
    },
    Cash: {
      address: '0xaE17f4F5CA32F77ea8e3786db7C0b2FE877aC176',
    },
    Bond: {
      address: '0x711eE4E2e51B776682A9408D0DA92C22283f257F',
    },
    Share: {
      address: '0x03066dA434e5264ef0B32f787923f974A5726fDc',
    },
    Boardroom: {
      address: '0x9c3619dE983ee58bA207B0242F52b26EbE46610a',
    },
    Treasury: {
      address: '0x6233a18bFFA2b0d7F6c66b000f14Aa2Fc965A697',
    },
    BCCBACPool: {
      address: '0x34f24991234067B63149D34691B5C17641Afe60C',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'basisCash_', type: 'address'},
    ...
    BCCBASPool: {
      address: '0x08986f3E298fA25ebA13b1B5507c6569F653a0d1',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'basisCash_', type: 'address'},
            {internalType: 'address', name: 'bas_', type: 'address'},
            {internalType: 'uint256', name: 'starttime_', type: 'uint256'},
          ],
          stateMutability: 'nonpayable',
          type: 'constructor',
    ...
    BCCDAIPool: {
      address: '0xd12ff490EEd822924F022deD3D272F3eEBD3859E',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'basisCash_', type: 'address'},
    ...
    BCCDSDPool: {
      address: '0x0f4Aab28947725f25a863d1Ec09858Ec0ac43dfc',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'basisCash_', type: 'address'},
    ...
    BCCESDPool: {
      address: '0x024D43aC1dAC185a888daA567b78B241e4edA9c3',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'basisCash_', type: 'address'},
    ...
    BCCUSDCPool: {
      address: '0x3FDC28901216c6eD39E0CfAd89b8111Bd46033bC',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'basisCash_', type: 'address'},
    ...
    DAIBCCLPTokenSharePool: {
      address: '0xE545097E7A47F1E007b0A998e8a00741b9477B20',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'basisShare_', type: 'address'},
    ...
    DAIBCSLPTokenSharePool: {
      address: '0x674d4a53C708017d9c8337c714A7E09007F5B323',
      abi: [
        {
          inputs: [
            {internalType: 'address', name: 'basisShare_', type: 'address'},
    ...
    dai_bcc_lpt: {
      address: '0x0E236240c4E9A26E4E8D6d516fC2C028F6FdC3BB',
    },
    dai_bcs_lpt: {
      address: '0xB3e325B62C0C3222c1ADc16f530D5dbA7A01f7bA',
    },
  },
}
